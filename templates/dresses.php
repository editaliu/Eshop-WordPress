...
<section id="goods" class="goods">
    <div class="section-heading greens">
        <?php
            echo do_shortcode(get_field('dr_heading'));
        ?>
            <!-- <h2>Our Goods</h2> -->
    </div>
    <?php
        if(have_rows('dr_container_repeater')):
            while(have_rows('dr_container_repeater')): the_row();
    ?>
        <!--     container of all 4-->
        <div class="container flex-container">
            <?php
                if(have_rows('dr_goods_repeater')):
                    while(have_rows('dr_goods_repeater')): the_row();
